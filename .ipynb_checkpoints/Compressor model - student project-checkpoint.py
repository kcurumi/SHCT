...
def recip_comp_SP(param, refrigerant, transcrit=False):
    ...
    m_dot = 1./z_e['v']*eta_vol*(np.pi/4.*(50.e-3)**2.*(39.3e-3))*48.55/2.*4 # Der Verdichter hat zwei Zylinder aber die mechanische Frequenz entspricht nur der Hälfte der elektrischen Frequenz --> in italiano: il compressore ha due cilindri ma la frequenza meccanica corrisponde solo alla metà della frequenza elettrica
    # adapt m_dot to D

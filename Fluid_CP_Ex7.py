...
def state(Var,In,fluid,Eh="CBar"):
    if ".MIX" in fluid:
        st=state_mix(Var,In,fluid,Eh)
    else:
        st=state_pure(Var,In,fluid,Eh)
    return st




def state_mix(Var,In,fluid,Eh="CBar"):
...
# p and h
    if Var[0]=="p" and Var[1]=="h":
        if Eh=="CBar":
            ...
            h=In[1]
        def hilf(T):
            h_=CP.PropsSI("H","T",T[0],"P",p,fluid)
            return h_-h
        T=fsolve(hilf,303.)[0]
        v=1./CP.PropsSI("D","T",T,"P",p,fluid) 
        u=CP.PropsSI("U","T",T,"P",p,fluid) 
...
#################################################################♠
    ...
    if Var[0]=="p" and Var[1]=="s":
        if Eh=="CBar":
            ...
            p=In[0]
        def hilf(T):
            s_=CP.PropsSI("S","T",T[0],"P",p,fluid)
            return s_-s
        T=fsolve(hilf,303.)[0]
        v=1./CP.PropsSI("D","T",T,"P",p,fluid) 
        u=CP.PropsSI("U","T",T,"P",p,fluid) 
...
def state_pure(Var,In,fluid,Eh="CBar"):
